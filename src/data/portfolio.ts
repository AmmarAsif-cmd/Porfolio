...
export const portfolioData = {
    ...
    projects: [
        ...
        },
        {
            ...
            title: "Canana",
            category: "WordPress",
            overview: "Freelance project. Delivered design improvements and secure payment gateway integration for this artisan brand.",
            problem: "The existing design was outdated and lacked local payment options, causing cart abandonment.",
            role: ["Freelance Developer", "Theme Developer"],
            challenges: ["Integrating specific local payment gateways.", "Refining the UI for a premium, artistic feel."],
            learnings: ["Payment API security & compliance.", "UX-driven design iteration."],
            techStack: ["WordPress", "WooCommerce", "GSAP", "PHP"],
