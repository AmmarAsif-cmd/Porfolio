...
export const portfolioData = {
    ...
    projects: [
        ...
        },
        {
            ...
            problem: "Identifying trends early is difficult due to data noise. TrendArc aggregates and visualizes data to make it actionable.",
            role: ["Full Stack Developer", "Data Engineer"],
            challenges: [
                "Processing large datasets efficiently in the browser.",
        ...
        },
        {
            ...
            category: "Research",
            overview: "A virtual try-on system allowing users to see clothes on themselves virtually using deep learning.",
            problem: "Online shopping lacks the 'try-on' experience, leading to high return rates.",
            role: ["Researcher", "Developer"],
            challenges: [
                "Implementing complex GAN (Generative Adversarial Network) architectures.",
                "Real-time image processing latency.",
            ],
            learnings: [
                "Integration of AI models into web applications.",
                "Computer Vision techniques.",
            ],
            techStack: ["Python", "OpenCV", "PyTorch", "Flask"],
            image: "",
            featured: true,
        },
        {
            ...
            category: "Research",
            overview: "MSc Dissertation focused on applying advanced AI algorithms to messy real-world datasets.",
            problem: "Theoretical AI models often fail on unstructured, noisy real-world data.",
            role: ["Researcher"],
            challenges: [
